document.addEventListener('DOMContentLoaded', () => {
    ...
    function cargarProductos() {
      ...
      fetch('http://localhost:3000/productos')  // Reemplaza la URL con la de tu servidor
    ...
    function agregarAlCarrito(producto) {
      ...
      if (productoEnCarrito) {
        // Si el producto ya está en el carrito, incrementar cantidad y precio
    ...
    function mostrarCarrito() {
        ...
        carrito.forEach(item => {
          ...
          totalCompra += item.precio * item.cantidad; // Actualizar el total de la compra
        });
